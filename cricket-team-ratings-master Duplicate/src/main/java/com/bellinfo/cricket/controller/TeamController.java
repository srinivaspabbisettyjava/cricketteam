...
//	}
  ...
  @RequestMapping(value="/editplayer/{id}", method=RequestMethod.GET)
	...
	@RequestMapping(value="/registrationpage/{id}", method=RequestMethod.GET)
	public ModelAndView registrationPage(@PathVariable Integer id){
	...
	public ModelAndView registrationPlayer(@ModelAttribute Player player){
		ModelAndView modelAndView = new ModelAndView("playerhome");
